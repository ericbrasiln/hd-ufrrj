...
## Visualização com displaCy {.center}
...
## Limpeza e preparação de dados {.center}
...
## Exemplo aplicado {.center}

Usando um corpus da **Hemeroteca Digital Brasileira** (OCR):

```python
with open("artigo1890.txt") as f:
    texto = f.read()
...
## Desafios para o português {.center}
